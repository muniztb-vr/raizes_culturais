    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <h3 className="font-serif text-lg font-bold text-forest-green">Recuperar senha</h3>
          <button onClick={onClose}
            className="w-8 h-8 flex items-center justify-center text-forest-green/40 hover:text-forest-green rounded-full">
        ...
        {estado === "enviado" ? (
          <div className="text-center py-4 flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-forest-green/60 leading-relaxed">
              Verifique sua caixa de entrada (e a pasta spam). O link expira em 15 minutos.
            </p>
            <button onClick={onClose}
              className="mt-2 px-5 py-2 bg-forest-green text-silk-cream rounded-xl text-sm font-semibold
      ...
      <div className="w-full max-w-sm px-4 sm:px-0">
        ...
        <Link to="/gestor/login"
          className="flex items-center justify-between w-full bg-white rounded-2xl px-5 py-4 shadow-sm
            border border-forest-green/12 hover:border-forest-green/30 hover:shadow-md transition-all group">
          ...
          <svg className="w-4 h-4 text-forest-green/40 group-hover:text-forest-green transition-colors"
